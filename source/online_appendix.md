...
Manuscript source:
- `who_still_answers_option_c_manuscript.md` (not included in this repository; original artifact: `paper/who_still_answers_option_c_manuscript.md`)
...
- `who_still_answers_option_c_canonical_lock_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_option_c_canonical_lock_2026-04-04.md`)
- `who_still_answers_ws6_completion_memo_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_ws6_completion_memo_2026-04-04.md`)
...
1. durability entrant panel  
   `who_still_answers_durability_entrant_panel.parquet` (not included in this repository; original artifact: `processed/who_still_answers_durability_entrant_panel.parquet`)
2. answer-role question panel  
   `who_still_answers_answer_role_question_panel.parquet` (not included in this repository; original artifact: `processed/who_still_answers_answer_role_question_panel.parquet`)
3. answer-role tag-month panel  
   `who_still_answers_answer_role_tag_month_panel.csv` (not included in this repository; original artifact: `processed/who_still_answers_answer_role_tag_month_panel.csv`)
4. infrastructure bridge panel  
   `who_still_answers_infrastructure_bridge_panel.csv` (not included in this repository; original artifact: `processed/who_still_answers_infrastructure_bridge_panel.csv`)
...
Source table:
- `who_still_answers_single_focal_attrition_summary.csv` (not included in this repository; original artifact: `processed/who_still_answers_single_focal_attrition_summary.csv`)
...
Readout:
- `who_still_answers_durability_mechanism_readout_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_durability_mechanism_readout_2026-04-04.md`)
...
Readout:
- `who_still_answers_answer_role_mechanism_readout_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_answer_role_mechanism_readout_2026-04-04.md`)
...
The defensible claim is not that accepted-current certification is unaffected. The stronger claim is that the entrant-heavy shift is more pronounced in early and endorsed answer roles than in accepted-current certification.

### C3. Infrastructure Bridge

Readout:
- `who_still_answers_infrastructure_bridge_readout_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_infrastructure_bridge_readout_2026-04-04.md`)
...
- `who_still_answers_mechanism_decomposition_table.csv` (not included in this repository; original artifact: `processed/who_still_answers_mechanism_decomposition_table.csv`)
- `who_still_answers_finish_empirical_upgrades_readout_2026-04-16.md` (not included in this repository; original artifact: `paper/who_still_answers_finish_empirical_upgrades_readout_2026-04-16.md`)
...
- `who_still_answers_certification_conversion_ladder.csv` (not included in this repository; original artifact: `processed/who_still_answers_certification_conversion_ladder.csv`)
...
Primary gate file:
- `who_still_answers_ws6_small_sample_inference.csv` (not included in this repository; original artifact: `processed/who_still_answers_ws6_small_sample_inference.csv`)
...
Timing audit:
- `who_still_answers_ws6_timing_audit.csv` (not included in this repository; original artifact: `processed/who_still_answers_ws6_timing_audit.csv`)

Construct sensitivity:
- `who_still_answers_ws6_construct_sensitivity.csv` (not included in this repository; original artifact: `processed/who_still_answers_ws6_construct_sensitivity.csv`)
...
- `who_still_answers_timing_triangulation_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_timing_triangulation_2026-04-04.md`)

Additional timing support files:

- `who_still_answers_external_ai_timing_layer_readout_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_external_ai_timing_layer_readout_2026-04-04.md`)
- `who_still_answers_internal_ai_timing_trace_readout_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_internal_ai_timing_trace_readout_2026-04-04.md`)
- `who_still_answers_external_ai_timing_results.csv` (not included in this repository; original artifact: `processed/who_still_answers_external_ai_timing_results.csv`)
- `who_still_answers_internal_ai_timing_results.csv` (not included in this repository; original artifact: `processed/who_still_answers_internal_ai_timing_results.csv`)
...
- the strict question-side AI-ban timing layer is now the only canonical restricted timing layer

Canonical same-setting timing support:

- `who_still_answers_disclosed_ai_corpus_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_disclosed_ai_corpus_2026-04-04.md`)
- `who_still_answers_ai_ban_strict_question_side_2026-04-06.md` (not included in this repository; original artifact: `paper/who_still_answers_ai_ban_strict_question_side_2026-04-06.md`)
- `who_still_answers_disclosed_ai_counts.csv` (not included in this repository; original artifact: `processed/who_still_answers_disclosed_ai_counts.csv`)
- `who_still_answers_ai_ban_strict_question_side_results.csv` (not included in this repository; original artifact: `processed/who_still_answers_ai_ban_strict_question_side_results.csv`)

Earlier broader ban-window and posthistory timing files remain archival scaffolds, not canonical timing evidence.
...
Source table:
- `who_still_answers_pretrend_diagnostics_table.csv` (not included in this repository; original artifact: `processed/who_still_answers_pretrend_diagnostics_table.csv`)
...
- `who_still_answers_exposure_validation_ladder_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_exposure_validation_ladder_2026-04-04.md`)

Supporting files:

- `who_still_answers_jetbrains_calibration_readout_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_jetbrains_calibration_readout_2026-04-04.md`)
- `who_still_answers_jetbrains_calibration_table_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_jetbrains_calibration_table_2026-04-04.md`)
- `who_still_answers_jetbrains_calibration_table.csv` (not included in this repository; original artifact: `processed/who_still_answers_jetbrains_calibration_table.csv`)
...
The appendix reports the full tag ordering directly.
...
Source table:
- `who_still_answers_exposure_ranking_table.csv` (not included in this repository; original artifact: `processed/who_still_answers_exposure_ranking_table.csv`)
- `who_still_answers_16tag_external_calibration_table.csv` (not included in this repository; original artifact: `processed/who_still_answers_16tag_external_calibration_table.csv`)
...
Positioning memo:
- `who_still_answers_aidev_positioning_note_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_aidev_positioning_note_2026-04-04.md`)

Supporting files:

- `who_still_answers_aidev_second_setting_prototype_readout_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_aidev_second_setting_prototype_readout_2026-04-04.md`)
- `who_still_answers_aidev_fe_results.csv` (not included in this repository; original artifact: `processed/who_still_answers_aidev_fe_results.csv`)
- `who_still_answers_aidev_strict_overlap_fe_results.csv` (not included in this repository; original artifact: `processed/who_still_answers_aidev_strict_overlap_fe_results.csv`)
- `who_still_answers_aidev_domain_overlap_upgrade_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_aidev_domain_overlap_upgrade_2026-04-04.md`)
- `who_still_answers_aidev_domain_overlap_results.csv` (not included in this repository; original artifact: `processed/who_still_answers_aidev_domain_overlap_results.csv`)
- `who_still_answers_devgpt_source_map_2026-04-05.md` (not included in this repository; original artifact: `paper/who_still_answers_devgpt_source_map_2026-04-05.md`)
- `who_still_answers_devgpt_positioning_2026-04-05.md` (not included in this repository; original artifact: `paper/who_still_answers_devgpt_positioning_2026-04-05.md`)
- `who_still_answers_devgpt_sidecar_readout_2026-04-05.md` (not included in this repository; original artifact: `paper/who_still_answers_devgpt_sidecar_readout_2026-04-05.md`)
- `who_still_answers_devgpt_sidecar_results.csv` (not included in this repository; original artifact: `processed/who_still_answers_devgpt_sidecar_results.csv`)
...
Reference files:
- `who_still_answers_option_c_display_packet.md` (not included in this repository; original artifact: `paper/who_still_answers_option_c_display_packet.md`)
- `who_still_answers_rendered_tables_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_rendered_tables_2026-04-04.md`)
- `who_still_answers_rendered_figures_2026-04-04.md` (not included in this repository; original artifact: `paper/who_still_answers_rendered_figures_2026-04-04.md`)

Core figures:

- `who_still_answers_durability_mechanism.png` (not included in this repository; original artifact: `figures/who_still_answers_durability_mechanism.png`)
- `who_still_answers_answer_role_mechanism.png` (not included in this repository; original artifact: `figures/who_still_answers_answer_role_mechanism.png`)
- `who_still_answers_infrastructure_bridge.png` (not included in this repository; original artifact: `figures/who_still_answers_infrastructure_bridge.png`)
- `who_still_answers_ws6_conservative_inference.png` (not included in this repository; original artifact: `figures/who_still_answers_ws6_conservative_inference.png`)
- `who_still_answers_ws6_timing_rank_panel.png` (not included in this repository; original artifact: `figures/who_still_answers_ws6_timing_rank_panel.png`)
...
Source table:
- `who_still_answers_residual_queue_complexity_summary_stats.csv` (not included in this repository; original artifact: `processed/who_still_answers_residual_queue_complexity_summary_stats.csv`)
...
- `build_who_still_answers_moderation_summary.json` (not included in this repository; original artifact: `processed/build_who_still_answers_moderation_summary.json`)
- `build_who_still_answers_moderation_panel.csv` (not included in this repository; original artifact: `processed/build_who_still_answers_moderation_panel.csv`)
- `build_who_still_answers_moderation_layer.py` (not included in this repository; original artifact: `scripts/build_who_still_answers_moderation_layer.py`)
...
- the line is therefore retained only as appendix context on policy-side content handling, not as an identification layer
